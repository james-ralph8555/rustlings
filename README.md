...
```bash
curl -L https://raw.githubusercontent.com/james-ralph8555/rustlings/main/install.sh | bash
```
Or if you want it to be installed to a different path:

```bash
curl -L https://raw.githubusercontent.com/james-ralph8555/rustlings/main/install.sh | bash -s mypath/
```
